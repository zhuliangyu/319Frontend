...
import {Avatar, Box, CardMedia, Divider, Grid, Icon, withStyles} from "@material-ui/core";
...
const ProfileCard = ({name, designation, group, officeLocation}) => {
                ...
                <Grid container item xs={8} justify={"flex-start"}>
                    <div className={classes.details}>
                        <CardContent padding={0}>
                            ...
                            <ParagraphTypography align={"left"}>{group} & {officeLocation}</ParagraphTypography>
                        </CardContent>
                    </div>
                </Grid>
            </Grid>
